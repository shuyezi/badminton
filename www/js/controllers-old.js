...
//     //弹出详情
//     $ionicModal.fromTemplateUrl('activityDetailModel', {
//       scope: $scope,
//       animation: 'slide-in-up'
//     }).then(function(modal) {
//       $scope.activityDetailModel = modal;
//     });
//     // // 当隐藏的模型时执行动作
//     // $scope.$on('activityDetailModel.hide', function() {
//     //   // 执行动作
//     // });
//     // // 当隐藏的模型时执行动作
//     // $scope.$on('activityDetailModel.show', function() {
//     //   // 执行动作
//     // });
//     $scope.showDetail = function(item){
//       $scope.winHeight = window.innerHeight;
//       $scope.winWidth = window.innerWidth;
//       $scope.activityDetail = item;
//       $scope.activityDetailModel.show();
//     }
